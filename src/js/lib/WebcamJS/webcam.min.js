...
(function(e) {
    var Webcam = {
        ...
        init: function() {
            ...
            this.userMedia = this.userMedia && !!navigator.getUserMedia && !!e.URL;
        ...
        attach: function(t) {
            ...
            t.appendChild(a);
            this.peg = a;
            if (!this.params.width) this.params.width = t.offsetWidth;
            if (!this.params.height) this.params.height = t.offsetHeight;
            ...
            if (this.userMedia) {
                ...
                r.setAttribute("autoplay", "autoplay");
                r.style.width = "" + this.params.dest_width + "px";
                r.style.height = "" + this.params.dest_height + "px";
                if (i != 1 || s != 1) {
                    t.style.overflow = "hidden";
                    r.style.webkitTransformOrigin = "0px 0px";
                    r.style.mozTransformOrigin = "0px 0px";
                    r.style.msTransformOrigin = "0px 0px";
                    r.style.oTransformOrigin = "0px 0px";
                    r.style.transformOrigin = "0px 0px";
                    r.style.webkitTransform = "scaleX(" + i + ") scaleY(" + s + ")";
                    r.style.mozTransform = "scaleX(" + i + ") scaleY(" + s + ")";
                    r.style.msTransform = "scaleX(" + i + ") scaleY(" + s + ")";
                    r.style.oTransform = "scaleX(" + i + ") scaleY(" + s + ")";
                    r.style.transform = "scaleX(" + i + ") scaleY(" + s + ")"
                }
                t.appendChild(r);
                this.video = r;
                var o = this;
                navigator.getUserMedia({
                    ...
                    r.src = e.URL.createObjectURL(t) || t;
                    Webcam.stream = t;
                    Webcam.loaded = true;
                    Webcam.live = true;
                    ...
                    return o.dispatch("error", "Could not access webcam.")
                })
            } else {
            ...
            if (this.params.crop_width && this.params.crop_height) {
                ...
                var n = Math.floor(this.params.crop_height * s);
                t.style.width = "" + l + "px";
                t.style.height = "" + n + "px";
                t.style.overflow = "hidden";
                t.scrollLeft = Math.floor(this.params.width / 2 - l / 2);
                t.scrollTop = Math.floor(this.params.height / 2 - n / 2)
            } else {
                t.style.width = "" + this.params.width + "px";
                t.style.height = "" + this.params.height + "px"
            }
        },
        reset: function() {
        ...
        on: function(e, t) {
            ...
            if (typeof this.hooks[e] == "undefined") throw "Event type not supported: " + e;
            this.hooks[e] = t
        },
        dispatch: function() {
            ...
            if (this.hooks[t]) {
                if (typeof this.hooks[t] == "function") {
                    this.hooks[t].apply(this, a)
                } else if (typeof this.hooks[t] == "array") {
                    this.hooks[t][0][this.hooks[t][1]].apply(this.hooks[t][0], a)
                } else if (e[this.hooks[t]]) {
                    e[this.hooks[t]].apply(e, a)
                }
                return true
            }
            return false
        ...
        detectFlash: function() {
            ...
            if (typeof r.plugins !== "undefined" && typeof r.plugins[t] === "object") {
                ...
                if (h && (typeof r.mimeTypes !== "undefined" && r.mimeTypes[i] && r.mimeTypes[i].enabledPlugin)) {
                    o = true
                }
        ...
        getSWFHTML: function() {
            ...
            if (!this.swfURL) {
                ...
                for (var s = 0, r = i.length; s < r; s++) {
                    var o = i[s].getAttribute("src");
                    if (o && o.match(/\/webcam(\.min)?\.js/)) {
                        a = o.replace(/\/webcam(\.min)?\.js.*$/, "");
                        s = r
                    }
                }
                if (a) this.swfURL = a + "/webcam.swf";
        ...
        getMovie: function() {
            ...
            if (!e) this.dispatch("error", "Cannot locate Flash movie in DOM");
            return e
        },
        freeze: function() {
            var e = this;
        ...
        snap: function(e, t) {
            ...
            if (!e) return this.dispatch("error", "Please provide a callback function or canvas to snap()");
            if (this.preview_active) {
        ...
        base64DecToArr: function(e, t) {
            var a = e.replace(/[^A-Za-z0-9\+\/]/g, ""),
                ...
                r = new Uint8Array(s);
            for (var o, h, l = 0, n = 0, c = 0; c < i; c++) {
                h = c & 3;
                l |= this.b64ToUint6(a.charCodeAt(c)) << 18 - 6 * h;
                if (h === 3 || i - c === 1) {
                    for (o = 0; o < 3 && n < s; o++, n++) {
                        r[n] = l >>> (16 >>> o & 24) & 255
                    }
        ...
        upload: function(e, t, a) {
            if (a) Webcam.on("uploadComplete", a);
            var i = "webcam";
            var s = "";
